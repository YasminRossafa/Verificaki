...
const LogoSvg = ({ size = 38 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden="true">
    <path
      d="M2.6 16 Q16 4 29.4 16 Q16 28 2.6 16 Z"
      fill="#EAF1FD"
      stroke="#1A73E8"
      strokeWidth="2.3"
      strokeLinejoin="round"
    ...
    <path
      d="M16 8.4 V11 M16 21 V23.6 M8.4 16 H11 M21 16 H23.6"
      stroke="#fff"
      strokeWidth="1.2"
      strokeLinecap="round"
    />
...
function Verificaki() {
  ...
  const toResult = (
    ...
    setDisplayScore(0);
    setGaugeScore(0);
    timers.current.gauge = window.setTimeout(
      () => setGaugeScore(finalScore),
      90,
    );
  ...
  const errMsgs: Record<InputType, string> = {
    image:
      "Não foi possível reconhecer a imagem. Tente enviar uma imagem mais nítida ou com texto legível.",
      ...
      >
        <div
          style={{
            height: 3,
            background:
              "linear-gradient(90deg,#1A73E8 0%,#1A73E8 55%,#34A853 55%,#34A853 100%)",
          }}
        />
        <div
          style={{
        ...
        >
          <button
            onClick={goHome}
            aria-label="Verificaki, ir para o início"
            style={{
              display: "flex",
              alignItems: "center",
              gap: 11,
      ...
      <main style={{ flex: 1, width: "100%" }}>
        {screen === "home" && (
          <section
            style={{
              ...
              margin: "0 auto",
              padding:
                "clamp(34px,6vw,76px) clamp(18px,5vw,40px) clamp(40px,6vw,80px)",
            }}
          >
            <div
            ...
            >
              <h1
                style={{
                  fontFamily: "'Source Serif 4',serif",
                  fontWeight: 700,
                  fontSize: "clamp(33px,6.2vw,60px)",
                  lineHeight: 1.06,
                  letterSpacing: "-.02em",
                  color: "#0E2A47",
                  margin: "20px 0 0",
              ...
              >
                Cole um link, digite um texto ou faça upload de uma imagem para
            ...
            <div
              style={{
                ...
                borderRadius: 18,
                boxShadow: "0 18px 50px -22px rgba(14,42,71,.28)",
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 700,
                  cursor: "pointer",
                  boxShadow: "0 10px 24px -10px rgba(26,115,232,.7)",
              ...
              >
                Análise gratuita · Resultado em segundos · Sem cadastro
              </p>
            </div>
          </section>
        )}
        ...
        {screen === "loading" && (
          ...
          >
            ...
            >
              <span
                style={{
                  ...
                  borderRadius: "50%",
                  background: "#cfe0fb",
                  animation: "vk-ring 1.8s ease-out infinite",
                }}
              />
              <span
                style={{
                  ...
                  borderRadius: "50%",
                  background: "#bfe3cb",
                  animation: "vk-ring 1.8s ease-out infinite .9s",
                }}
              />
              <span
                style={{
                  ...
                  background: "#fff",
                  borderRadius: "50%",
                  boxShadow: "0 12px 30px -10px rgba(14,42,71,.3)",
            ...
            >
              ...
              <span style={{ animation: "vk-blink 1.2s steps(1) infinite" }}>
                ...
              </span>
            </h2>
            <p style={{ fontSize: 15, color: "#80868B", margin: 0 }}>
              Aguarde alguns segundos enquanto cruzamos as fontes
            </p>
            ...
            >
              ...
              >
                <strong style={{ color: "#5a4a10" }}>Sabia?</strong> Mais de 60%
                das notícias falsas são compartilhadas sem qualquer verificação.
              </p>
            </div>
            ...
            >
              <div
                style={{
                  ...
                  boxShadow: "0 14px 40px -22px rgba(14,42,71,.25)",
                  textAlign: "center",
                }}
              >
                <p
                ...
                <div style={{ width: "100%", maxWidth: 300, margin: "0 auto" }}>
                  ...
                  >
                    {displayScore}
                    <span style={{ fontSize: ".5em", color: "#80868B" }}>
                      %
                    </span>
                  </div>
                </div>
                      ...
                      >
                        {showAllSources ? (
                          ...
                          <>
                            ...
                            Ver mais {sources.length - 3} fonte
        ...
        {screen === "error" && (
          ...
          >
            ...
            >
              O sistema não conseguiu entender o conteúdo enviado.
            </p>
            ...
            >
              ...
              >
                <strong>Dica:</strong> certifique-se de que o link é de uma
                notícia, o texto tem ao menos 100 caracteres ou a imagem contém
                texto visível.
              </p>
            </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
            ...
            <span style={{ fontSize: 14, color: "#5F6368" }}>
              Verificaki © 2026 — Combatendo a desinformação
            </span>
          </div>
          <div
            style={{
          ...
          >
            <a
              href="#privacidade"
              style={{ textDecoration: "none", color: "#80868B" }}
            >
              Privacidade
            </a>
          </div>
      ...
      {install !== "hidden" && (
        <div
          style={{
            ...
            borderRadius: 16,
            boxShadow: "0 18px 48px -12px rgba(14,42,71,.4)",
            padding: "16px 18px",
            animation: "vk-slideup .42s cubic-bezier(.2,.85,.25,1)",
          }}
        >
          <button
          ...
          >
            <span
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                boxShadow: "0 8px 18px -8px rgba(26,115,232,.7)",
              }}
            >
              <svg
                width="28"
